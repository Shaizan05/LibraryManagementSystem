<%-- 
    Document   : index
    Created on : 31 Aug, 2023, 12:08:29 PM
    Author     : njuser
--%>
    ...
    <body onload="Loader('dashboard')">
                ...
                <div class="collapse navbar-collapse" id="myNavbar" style="margin-top:20px;">
                    ...
                    <ul class="nav navbar-nav navbar-right input-group">
                        ...
                        <li style="margin-top:-5px;">
                            ...
                            <i  class="fa-solid fa-user"  style="color: black; margin: 20px;cursor: pointer; " href="loginRegister.jsp"> <a href="loginRegister.jsp" id="loginRegister" >LOG IN</a></i>

                            <i class="fa-solid fa-user-plus" style="color: black; margin: 20px; cursor: pointer;" onclick="loginRegister('register')" >  <a href="loginRegister.jsp" id="loginRegister">REGISTER</a></i>
        ...
        <div class="container-fluid text-center ">    
            <div class="row content ">
                <div class="col-sm-2 sidenav hidden-xs"  id="myNavbar">
                    <ul class="nav nav-pills nav-stacked " id="pills-tab" role="tablist">
                        <li class="nav-item"><a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#section1" onclick="Loader('dashboard')">Home</a></li>
                        ...
                        <div class="d-lg-flex justify-content-between">
                            ...
                            <div style="width: 550px; padding: 5px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; font-size: 17px; ">
                                    ...
                                    <a style="cursor:pointer;" onclick="Loader('dashboard')">Home</a>
