...
<!DOCTYPE html>
<c:if test="${process eq 'trendingBooks'}">
    ...
    <html>
        ...
        <body>
            ...
            <div id='maindiv'>
                ...
                <center>
                    <H2 style="margin-top:10px ;color: black;">TRENDING BOOKS </H2></center>
                <div id="bigdiv" >
                    <div class="container1">
                        <div class="" style="justify-content: space-around;display:flex; flex-wrap:wrap;">
                            ...
                            <%
                                ...
                                while (rs.next()) {
                                 if(rs.getString("btype").equals("MANGA")){
                            %>
                            ...
                            <div class="flip" style="width:200px;border-radius: 7px;margin: 10px">
                                ...
                                <div class="back" style="padding: 7px;font-size: small">
                                    ...
                                    <button class="btn btn-primary" data-bookId="<%=rs.getString("bookId")%>" onclick="showRent(this)" >GET</button> 
                                    </div>
                                    <div id="rentModal">
